function [result, dummy]=eyelink_init(dummy, enableCallbacks)
% USAGE: [result dummy]=eyelink_init([dummy=0][enableCallbacks=1])
%
% Initialize Eyelink system and connection. DOES NOT ATTEMPT DUMMY MODE ON FAIL
% Optional arguments:
%
...
% 13-05-15  jd  Removed default, unfixable behavior of popping up a
%               dialogue box that is not close-able when there's a PTB window
%               on the screen.
